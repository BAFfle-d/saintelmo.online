...
export default function App() {
  ...
  const act1Scenes: Scene[] = [
    ...
    { 
      ...
      script: [
        ...
        { type: 'stage-direction', text: `BUCK JR. shakes the hand of OFFICER. GEOFF and MAXIE are goofing off.` },
        { type: 'dialogue', speaker: 'BUCK JR', text: `You'll have an escort from Pine Ridge Minimum Security daily and at least during transport.` },
        { type: 'dialogue', speaker: 'BUCK JR', text: `From 8 to 8 six days a week, you'll be here working and you cannot leave these premises.` },
        { type: 'dialogue', speaker: 'MAXIE', text: `How very liturgical.` },
        { type: 'dialogue', speaker: 'BUCK JR', text: `They do have religious services there, and the rabbi sits on the release board.` },
        { type: 'dialogue', speaker: 'GEOFF', text: `I'll practice my Hebrew.` },
        { type: 'dialogue', speaker: 'MAXIE', text: `Wouldn't it be God's joke - to lock you up solely to bring you back to the faith?` },
        { type: 'dialogue', speaker: 'GEOFF', text: `If God is real, he's really funny, if I'm the focus of all his divine attention.` },
        { type: 'dialogue', speaker: 'BUCK JR', text: `Consider it a time for reflection. Think optics, early release. You could be out in 18 months.` },
        ...
        { type: 'stage-direction', text: `STACEY pulls phone out - it's buzzing. STACEY taps BUCK JR on the shoulder and nods toward the door.` },
        ...
        { type: 'dialogue', speaker: 'STACEY', text: `I'm Stacey, Mr. Goldstein. We've talked on the phone. Mr. Buck's paralegal. While he's out, I was wondering if you've filed the community center's documents?` },
        { type: 'dialogue', speaker: 'GEOFF', text: `Yes! Sweet choruses of angels - that lovely voice has a lovely face!` },
        { type: 'dialogue', speaker: 'STACEY', text: `(flattered) Thank you, sir. While he's out, I was wondering if you've filed?` },
        { type: 'dialogue', speaker: 'GEOFF', text: `I'll have it tomorrow. And the staff list?` },
        { type: 'dialogue', speaker: 'STACEY', text: `I'll check, but the court didn't mention a staff list. Check with him, but I'll note it.` },
        { type: 'dialogue', speaker: 'GEOFF', text: `Thank you, princess. I'll get it done as soon as we finish. You have my direct line?` },
        ...
        { type: 'dialogue', speaker: 'MAXIE', text: `I almost feel I'm looking at one of my sisters, well except for the blonde. What's your name, dear?` },
        { type: 'dialogue', speaker: 'STACEY', text: `Thank you, Ms. Laurent. My gradfather came -` },
        ...
        { type: 'dialogue', speaker: 'MAXIE', text: `Builds character. But there's always temptation.` },
        ...
        { type: 'dialogue', speaker: 'GEOFF', text: `I look after my friends. Buck Senior's one of the best - good family, great man.` },
        ...
        { type: 'dialogue', speaker: 'BUCK JR', text: `-off scott free. (Laughing) Be more careful. You practically handed them the shovel.` },
        ...
        { type: 'dialogue', speaker: 'GEOFF', text: `Seriously, though, kid. You did great. If you ever need a phone call, a recommendation, a reference - you call me.` },
    ...
    { 
      ...
      script: [
        ...
        { type: 'dialogue', speaker: `MAXIE`, text: `Has been extended but — don't worry — I didn't touch your office. Now there's more room. It doesn't feel like your neighbor's basement mancave.` },
        ...
        { type: 'dialogue', speaker: `GEOFF`, text: `I threw him into my life at the most chaotic moment and look how he's blossomed. He's level-headed, smart, and doesn't ask questions.` },
        ...
        { type: 'dialogue', speaker: `GUS`, text: `Actually, one thing though. It's not really my business, but just so I know how to respond if the question comes up again.` },
        { type: 'dialogue', speaker: `MAXIE`, text: `Yes?` },
        { type: 'dialogue', speaker: `GUS`, text: `One of the guests asked for something I didn't understand. The Prince — well —` },
        { type: 'dialogue', speaker: `GUS`, text: `The man who said he was a prince.` },
        { type: 'dialogue', speaker: `MAXIE`, text: `Prince Rashid. He always pushes for too much. He's handsy like Ronnie but lucky for him his hands usually have money in them.` },
        { type: 'dialogue', speaker: `GEOFF`, text: `It is his whole personality.` },
        { type: 'dialogue', speaker: `GUS`, text: `Right. He tipped well. And maybe it was a language thing — I mean, I'm pretty sure it wasn't — but I told him the schedule was fixed and couldn't accommodate other activities.` },
        { type: 'dialogue', speaker: `MAXIE`, text: `Good. You did exactly the right thing.` },
        { type: 'stage-direction', text: `(Beat. Gus nods slowly.)` },
        { type: 'dialogue', speaker: `GUS`, text: `Yeah. Language thing.` },
        { type: 'dialogue', speaker: `MAXIE`, text: `He liked the way you handled it professionally.` },
        { type: 'dialogue', speaker: `GEOFF`, text: `Made me look like an actual freaking adult in front of royalty.` },
        { type: 'stage-direction', text: `(Beat.)` },
        { type: 'dialogue', speaker: `MAXIE`, text: `We all have our roles. Junior here does the tedium and paperwork.` },
        { type: 'dialogue', speaker: `BUCK JR.`, text: `I'm your lawyer. I do liability and contracts. What do you mean tedium? It's very in-depth, complex work.` },
        { type: 'dialogue', speaker: `MAXIE`, text: `It's tedious.` },
        { type: 'dialogue', speaker: `GEOFF`, text: `She's not saying you're tedious, just the paperwork. Maxie gets the fun part — networking, playing golf, hobnobbing.` },
        { type: 'dialogue', speaker: `MAXIE`, text: `It is fun, you're right. And Geoff, you know, likes his accountancy. The money.` },
        { type: 'dialogue', speaker: `GEOFF`, text: `And that leaves a role open that we need to fill before I escape this prison.` },
        { type: 'dialogue', speaker: `GEOFF`, text: `How do you feel about a little promotion?` },
        { type: 'dialogue', speaker: `GUS`, text: `To what? That's everything.` },
        { type: 'dialogue', speaker: `MAXIE`, text: `Operations, darling. You'll go ahead of us to Lil' Elmo and make sure everything is ready for Geoff's guests ahead of his first trip there since his incarceration. Walk the runway, make sure the t's are crossed and the i's are dotted.` },
        { type: 'dialogue', speaker: `GEOFF`, text: `Make sure she didn't destroy my office.` },
        { type: 'dialogue', speaker: `MAXIE`, text: `The staff is hired already — you'll do that in the future, but for now you're just going to make sure everything goes off without a hitch. You'll need to come back to New York when we arrive, though. Private party.` },
        { type: 'dialogue', speaker: `GEOFF`, text: `Sorry, old chum. Someone's got to make sure this old shack doesn't fall apart.` },
        { type: 'dialogue', speaker: `GUS`, text: `You're serious.` },
        { type: 'dialogue', speaker: `MAXIE`, text: `You'll remain Geoff's PA.` },
        { type: 'dialogue', speaker: `GEOFF`, text: `And I can't go anywhere. Think of it for now as an extension of your duties. And if it goes off swimmingly…` },
        { type: 'dialogue', speaker: `MAXIE`, text: `Darling, don't I have a formal title?` },
        ...
        { type: 'dialogue', speaker: `MAXIE`, text: `Right. So —` },
        ...
        { type: 'dialogue', speaker: `MAXIE`, text: `Junior —` },
        ...
        { type: 'dialogue', speaker: `MAXIE`, text: `Okay. Well what is your title then, Junior?` },
        { type: 'dialogue', speaker: `BUCK JR.`, text: `Chief Legal Officer.` },
        { type: 'dialogue', speaker: `GEOFF`, text: `I wouldn't say VP just yet, but Director has a good ring — really it's a formality. You can tell people you are somebody, for the people who need that sort of thing.` },
        { type: 'dialogue', speaker: `GUS`, text: `Operations. Of the island.` },
        { type: 'dialogue', speaker: `GEOFF`, text: `Everything. You'd be my right hand. But again, that's a discussion and something to think about. Please — go to Saint Elmo for me and show me what you can do. Make sure it's perfect.` },
        { type: 'dialogue', speaker: `GEOFF`, text: `I need a vacation after all this —` },
        ...
        { type: 'dialogue', speaker: `MAXIE`, text: `You leave the morning after tomorrow. But if you don't have swimmies and ugly Hawaiian shirts, darling, I think it's time for a — can you guess?` },
        ...
        { type: 'dialogue', speaker: `GUS`, text: `For? I don't have the money to really — I've had to pay court fees and — I mean, you've been so generous, I should think about paying rent to Geoff soon since I'm living here —` },
        { type: 'stage-direction', text: `He does not get it yet, does he?` },
  ...
  const act2Scenes: Scene[] = [
    ...
    { id: "02-05", title: "Witch Hunt and a Snowstorm", summary: "The media frenzy and the cover-up collide.", hasMusic: true, youtubeId: "iJNhZs7p_2Y", script: [
    ...
    { id: "02-08", title: "Interrogation", summary: "A confrontation between Geoff and Maxie.", hasMusic: true, youtubeId: "08OeZlI8uf8", script: [
        { type: 'stage-direction', text: `The Office of the Solicitor General. TAMMY at her desk, reviewing briefs. The door opens without a knock.` },
        { type: 'stage-direction', text: `Two SECRET SERVICE AGENTS enter and sweep the room.` },
        { type: 'dialogue', speaker: 'SS1', text: `All clear.` },
        { type: 'dialogue', speaker: 'SS2', text: `All clear.` },
        { type: 'stage-direction', text: `Tammy looks up` },
        { type: 'stage-direction', text: `(without looking up)` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Can I help you gentlemen?` },
        { type: 'stage-direction', text: `(looking closer)` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Don't I know you from somewhere?` },
        { type: 'stage-direction', text: `(without expression)` },
        { type: 'dialogue', speaker: 'SS1', text: `We're with the President's detail, ma'am.` },
        { type: 'dialogue', speaker: 'SS2', text: `Always with the President.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `But aren't you—` },
        { type: 'dialogue', speaker: 'SS1', text: `We get that a lot.` },
        { type: 'dialogue', speaker: 'SS2', text: `We are simply his detail.` },
        { type: 'stage-direction', text: `Beat. Tammy decides not to pursue it.` },
        { type: 'stage-direction', text: `RONNIE enters.` },
        { type: 'dialogue', speaker: 'RONNIE', text: `Solicitor Tamela Osiris Caldwell. *(beat)* Osiris. Now that is a name. Egyptian, isn't it? Interesting choice for a Christian mama.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Mr. President. My mother had a deep fascination with ancient civilizations. She was also a devout Southern Baptist, as am I. Tammy is fine, if it pleases you.` },
        { type: 'dialogue', speaker: 'RONNIE', text: `Southern Baptist — good, good, I respect that. Ancient civilizations, huh? So your mother was the academic type. Probably went to one of those high-falutin' New England schools. Head in the clouds, wealthy, all of that —` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Sir, I don't think this line of questioning is appropriate. But no. My mother got her GED and graduated from a technical school. She dropped out of high school early to have me. I paid for law school myself.` },
        { type: 'stage-direction', text: `A Southern Baptist bootstrapper. I love that. So you went and got your JD from some fly-by-night college out in — Kansas somewhere —` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Yale, actually, sir.` },
        { type: 'stage-direction', text: `(a beat)` },
        { type: 'dialogue', speaker: 'RONNIE', text: `Yale. Well. I assume you went on to some big corporate firm after —` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Legal Aid. Southern Alabama. I became a judge, then was appointed to the state AG's office. I've been recognized a number of times for pro bono representation of clients living in poverty in the rural South.` },
        { type: 'stage-direction', text: `(moving right along)` },
        { type: 'stage-direction', text: `A Southern social climber — very impressive. Unmarried, I notice. I mean — unpartnered. I mean — a strong, independent woman, high-profile role, no children — I'm assuming you're probably a les —` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Mr. President. *Inappropriate.*` },
        { type: 'dialogue', speaker: 'RONNIE', text: `I don't have any problem with the LGBT — D — I — X — *(losing count)* — whatever they're calling themselves this year. More letters every time I turn around. I think we should just call them all gay. I mean, they are gay, right? It's better than calling anyone a dy —` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Sir.` },
        { type: 'stage-direction', text: `She stands.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `I am not afraid to remove you from my office. Is there a reason you are here today, or did you come specifically to insult me?` },
        { type: 'stage-direction', text: `Silence. Something shifts in Ronnie.` },
        { type: 'dialogue', speaker: 'RONNIE', text: `I need your help.` },
        { type: 'stage-direction', text: `A beat.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `This is highly unorthodox.` },
        { type: 'stage-direction', text: `She looks at the two agents.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Gentlemen.` },
        { type: 'dialogue', speaker: 'SS1', text: `Ma'am?` },
        { type: 'dialogue', speaker: 'TAMMY', text: `You'll be outside.` },
        { type: 'stage-direction', text: `(to Ronnie)` },
        { type: 'dialogue', speaker: 'SS1', text: `Sir?` },
        { type: 'stage-direction', text: `(a little too quickly)` },
        { type: 'dialogue', speaker: 'RONNIE', text: `Outside is fine.` },
        { type: 'stage-direction', text: `They exit. The door closes. The room is very quiet.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Sir, I'm going to assume you're aware that there are questions currently circulating about materials that originated — or appear to have originated — in proximity to this office.` },
        { type: 'dialogue', speaker: 'RONNIE', text: `I'm aware.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Then you understand that any conversation we have right now is — sensitive.` },
        { type: 'dialogue', speaker: 'RONNIE', text: `That's why I came myself.` },
        { type: 'stage-direction', text: `Beat. Tammy absorbs that. He came himself. No Cammie. No Ash.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `What is it you're asking me to do?` },
        { type: 'dialogue', speaker: 'RONNIE', text: `I need someone I can trust on this.` },
        { type: 'stage-direction', text: `(evenly)` },
        { type: 'dialogue', speaker: 'TAMMY', text: `On what, specifically.` },
        { type: 'stage-direction', text: `The — situation.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Mr. President, I'm going to need you to say the words.` },
        { type: 'stage-direction', text: `Ronnie shifts. This is not how this usually goes.` },
        { type: 'stage-direction', text: `The case. The whole — the island. The flights. The — all of it.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `And what would you like me to do about the case, the whole island, the flights, and all of it?` },
        { type: 'dialogue', speaker: 'RONNIE', text: `Well I'd like it to —` },
        { type: 'stage-direction', text: `He stops.` },
        { type: 'dialogue', speaker: 'RONNIE', text: `There are people involved who are — good people. Prominent people. People who have been very generous to this country.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `I'm sure they have been.` },
        { type: 'dialogue', speaker: 'RONNIE', text: `And I think with the right — framing — this whole thing could be —` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Contained?` },
        { type: 'stage-direction', text: `Ronnie stops. That word again, but coming from her.` },
        { type: 'dialogue', speaker: 'RONNIE', text: `...Yes.` },
        { type: 'stage-direction', text: `A long beat. Tammy looks at him.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Mr. President. Before I can have any conversation about the appropriate handling of any active matter — I need to understand what exactly you believe happened.` },
        { type: 'dialogue', speaker: 'RONNIE', text: `Well, now, that's — that's not really —` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Because if you're asking me to manage something on behalf of the government, I need to know what I'm managing. And if you're asking me to manage it on behalf of someone other than the government —` },
        { type: 'stage-direction', text: `She lets that land.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Then I need to know that too.` },
        { type: 'stage-direction', text: `Silence.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `So. In your own words, sir. What did you do?` },
        { type: 'stage-direction', text: `The lights shift. Music begins.` },
        { type: 'stage-direction', text: `[SONG: [Musical number occurs here]]` },
        { type: 'dialogue', speaker: 'RONNIE', text: `Well.` },
        { type: 'dialogue', speaker: 'RONNIE', text: `I think we understand each other.` },
        { type: 'stage-direction', text: `(beat, almost uncertain)` },
        { type: 'dialogue', speaker: 'RONNIE', text: `I'm glad we could get on the same page,` },
        { type: 'dialogue', speaker: 'RONNIE', text: `Madame Solicitor.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Mr. President.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `I now have a complete understanding` },
        { type: 'dialogue', speaker: 'TAMMY', text: `of where you're coming from.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `I appreciate you taking the time` },
        { type: 'dialogue', speaker: 'TAMMY', text: `to share your perspective on the ongoing matter.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `I will act in the best interest of the country.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `As I know you will.` },
        { type: 'stage-direction', text: `(perking up)` },
        { type: 'dialogue', speaker: 'RONNIE', text: `Absolutely. Absolutely.` },
        { type: 'stage-direction', text: `The country. That's — that's what it's about.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `It always has been, sir.` },
        { type: 'stage-direction', text: `(nodding, alrrady moving on)` },
        { type: 'dialogue', speaker: 'RONNIE', text: `Good. Good good good.` },
        { type: 'stage-direction', text: `Hey — where are my —` },
        { type: 'dialogue', speaker: 'RONNIE', text: `you know —` },
        { type: 'dialogue', speaker: 'RONNIE', text: `the two —` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Sir?` },
        { type: 'stage-direction', text: `The ones. With the —` },
        { type: 'stage-direction', text: `(vague gesture at his lapel)` },
        { type: 'stage-direction', text: `The earpieces.` },
        { type: 'stage-direction', text: `The Secret Service?` },
        { type: 'dialogue', speaker: 'RONNIE', text: `Is that what they are?` },
        { type: 'dialogue', speaker: 'RONNIE', text: `I can never keep anyone straight.` },
        { type: 'dialogue', speaker: 'RONNIE', text: `Too much up here.` },
        { type: 'stage-direction', text: `(taps temple)` },
        { type: 'dialogue', speaker: 'RONNIE', text: `President brain.` },
        { type: 'stage-direction', text: `The door opens. SS1 and SS2 enter.Tammy clocks them.She has definitely seen them before.` },
        { type: 'stage-direction', text: `(evenly)` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Of course, sir.` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Happy to unburden you.` },
        { type: 'stage-direction', text: `(already at the door, to the agents)` },
        { type: 'dialogue', speaker: 'RONNIE', text: `There you are.` },
        { type: 'dialogue', speaker: 'RONNIE', text: `You know I had to ask her where you were?` },
        { type: 'dialogue', speaker: 'RONNIE', text: `That's embarrassing for everybody.` },
        { type: 'stage-direction', text: `(without expression)` },
        { type: 'dialogue', speaker: 'SS1', text: `Our apologies, sir.` },
        { type: 'dialogue', speaker: 'SS2', text: `We were right outside.` },
        { type: 'dialogue', speaker: 'RONNIE', text: `Well next time be more —` },
        { type: 'stage-direction', text: `(searches for the word)` },
        { type: 'dialogue', speaker: 'RONNIE', text: `— present.` },
        { type: 'stage-direction', text: `He exits.The agents follow.The door closes.` },
        { type: 'stage-direction', text: `Tammy stands alone.She looks at the recorder in her hand.She doesn't click it off yet.` },
        { type: 'stage-direction', text: `(quietly, to no one)` },
        { type: 'dialogue', speaker: 'TAMMY', text: `Best interest of the country.` },
        { type: 'stage-direction', text: `She clicks it off.` },
        { type: 'stage-direction', text: `Lights shift.` }
      ] },
    { id: "02-09", title: "Just Like", summary: "Gus realizes his own complicity.", hasMusic: true, youtubeId: "wdesqA9Er9c", script: [
    ...
    { id: "02-12", title: "A Park Bench", summary: "A moment of reflection before the final trial.", hasMusic: true, youtubeId: "Jk3R5NF6eqs", script: [
        { type: 'stage-direction', text: `[NEWSREEL - rising from the pressure sequence music]` },
        { type: 'stage-direction', text: `[SUGGESTED STAGE DRESSING: The Washington Monument visible through the upstage window, center frame. Never referenced. Never lit for emphasis. Simply present for the duration of the scene.]` },
        { type: 'dialogue', speaker: `ANCHOR`, text: `In entertainment news tonight — Grammy-winning producer and rap mogul Big Pharaoh Thruxton, born Marcus DeShawn Pullman of Compton, has been arrested at his Bel Air compound after federal investigators declared the property a crime scene.` },
        { type: 'dialogue', speaker: `ANCHOR`, text: `Fresh allegations describe what witnesses refer to as drug- and alcohol-fueled binge parties called Thoth Downs in Big Pharoah Thruxton's Thothiverse, the name given to his secret guest house on the property, where young industry hopefuls were required to perform in what lawyers are describing as live performances of an artistic nature as Thruxton's Thoths, each assigned their own Thoth Title to the amusement and pleasure of celebrity guests for access and exposure to other entertainment industry figures.` },
    ...
    { id: "02-13", title: "It's not Unreasonable, Man", summary: "The Solicitor General's final stand.", hasMusic: true, youtubeId: "j1lVwTeycPQ", script: [
    ...
    { id: "02-14", title: "We Hold These Truths", summary: "The jury's verdict and the public's reaction.", hasMusic: true, youtubeId: "cSVe6MhYpC0", script: [
    ...
    { id: "02-15", title: "Rehabilitation", summary: "A satirical take on the political fallout.", hasMusic: true, youtubeId: "dv-ZFkmz_Bk", script: [
    ...
    { id: "02-16", title: "Orbiting", summary: "Gus finds a moment of peace and clarity.", hasMusic: true, script: [
